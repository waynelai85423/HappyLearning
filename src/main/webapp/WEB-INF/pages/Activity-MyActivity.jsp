...
<br>
    <div>
        <div class="fullwidth-template">
            ...
            <div class="teamo-tabs  default rows-space-40 participateActivitiesMode">
                <div class="container">
                    <div class="tab-head">
                        <ul class="tab-link">
                            <li class="active">
                        ...
                        <div id="bestseller" class="tab-panel active">
                            <div class="teamo-product">
                                <table class="u-table-entity">
                                    ...
                                    <tbody class="u-align-center u-table-body effectiveAttendees">
                        ...
                        <div id="top-rated" class="tab-panel">
                            <div class="teamo-product">
                                <table class="u-table-entity">
                                    ...
                                    <tbody class="u-align-center u-table-body AllAttendees">
