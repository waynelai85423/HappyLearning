...
//        label: 'Past Month',
//        fill: 'start',
//        data: [430, 120, 230, 410, 740, 472, 219, 391, 229, 400, 203, 301, 380, 291, 620, 700, 300, 630, 402, 320, 380, 289, 410, 300, 530, 630, 720, 780, 0],
//        backgroundColor: 'rgba(255,65,105,0.1)',
...
//      options: bouOptions
//    });
//    var ctx = new Chart(bouCtx, {
//      type: 'line',//'LineWithLine',
//      data: bouData,
//      options: bouOptions
//    });
...
//    window.BlogOverviewUsers.render();
    ...
    var ubdData = {
      datasets: [{
        ...
        data: [map[1].length, map[2].length, map[3].length, map[4].length],
        backgroundColor: [
          '#45FF45',
          '#FFB630',
          '#FFFF3B',
