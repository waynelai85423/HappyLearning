...
import fourth.ecpay.payment.integration.domain.ATMRequestObj;
import fourth.ecpay.payment.integration.domain.AioCheckOutALL;
import fourth.ecpay.payment.integration.domain.AioCheckOutATM;
import fourth.ecpay.payment.integration.domain.AioCheckOutApplePay;
import fourth.ecpay.payment.integration.domain.AioCheckOutBARCODE;
import fourth.ecpay.payment.integration.domain.AioCheckOutCVS;
import fourth.ecpay.payment.integration.domain.AioCheckOutDevide;
import fourth.ecpay.payment.integration.domain.AioCheckOutOneTime;
import fourth.ecpay.payment.integration.domain.AioCheckOutPeriod;
import fourth.ecpay.payment.integration.domain.AioCheckOutWebATM;
import fourth.ecpay.payment.integration.domain.CVSOrBARCODERequestObj;
import fourth.ecpay.payment.integration.domain.CreateServerOrderObj;
import fourth.ecpay.payment.integration.domain.DoActionObj;
import fourth.ecpay.payment.integration.domain.FundingReconDetailObj;
import fourth.ecpay.payment.integration.domain.InvoiceObj;
import fourth.ecpay.payment.integration.domain.QueryCreditCardPeriodInfoObj;
import fourth.ecpay.payment.integration.domain.QueryTradeInfoObj;
import fourth.ecpay.payment.integration.domain.QueryTradeObj;
import fourth.ecpay.payment.integration.domain.TradeNoAioObj;
...
import fourth.ecpay.payment.integration.verification.VerifyAioCheckOut;
import fourth.ecpay.payment.integration.verification.VerifyCreateServerOrder;
import fourth.ecpay.payment.integration.verification.VerifyDoAction;
import fourth.ecpay.payment.integration.verification.VerifyFundingReconDetail;
import fourth.ecpay.payment.integration.verification.VerifyQueryCreditTrade;
import fourth.ecpay.payment.integration.verification.VerifyQueryTrade;
import fourth.ecpay.payment.integration.verification.VerifyQueryTradeInfo;
import fourth.ecpay.payment.integration.verification.VerifyTradeNoAio;
