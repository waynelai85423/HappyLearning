...
public class MemberMailService {
	...
	private final static String SENDER = "ch570991400@gmail.com";
	private final static String PASSWORD = "ruvotguhuyntpvjg";
...
//   		寄出email
	...
	public String givenUsingJava8_whenGeneratingRandomAlphanumericString_thenCorrect() {
		...
		String generatedString = random.ints(getLeftLimit(), getRightLimit() + 1)
				.filter(i -> (i <= 57 || i >= 65) && (i <= 90 || i >= 97)).limit(9)
